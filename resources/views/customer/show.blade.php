...
@section('content')
    <x-heading-card>
        <h1 class="text-white display-1">Conference</h1>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="mb-5">
                        <div class="section-title position-relative mb-5">
                            <h6 class="d-inline-block position-relative text-secondary text-uppercase pb-2">Conference Info</h6>
                ...
                <div class="col-lg-4 mt-5 mt-lg-0">
                    <div class="bg-primary mb-5 py-3">
                        <h3 class="text-white py-3 px-4 m-0">About</h3>
                        <div class="d-flex justify-content-between border-bottom px-4">
                            <h6 class="text-white my-3">Starts</h6>
                        ...
                        <div class="d-flex justify-content-between border-bottom px-4">
                            <h6 class="text-white my-3">Contact Person</h6>
                            <h6 class="text-white my-3">{{$conference->contact_person}}</h6>
                        </div>
                        <div class="d-flex justify-content-between border-bottom px-4">
                            <h6 class="text-white my-3">Contact Email</h6>
                            <h6 class="text-white my-3">{{$conference->contact_email}}</h6>
                        </div>
                        <div class="py-3 px-4">
                            <a class="btn btn-block btn-secondary py-3 px-5" href="/customer/register">Register</a>
                        </div>
                    </div>
