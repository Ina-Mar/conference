                ...
                <div class="col-12 col-lg-9 col-xl-7">
                    <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
                        <div class="card-body p-4 p-md-5">
                            <h3 class="mb-4 pb-2 pb-md-0 mb-md-5">{{__('trans.Registration Form')}}</h3>
                            ...
                            @csrf
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <select name="conference_id" class="form-select form-control-lg">
                                            <option value="0" disabled>{{__('trans.Choose Conference')}}</option>
                                ...
                                <div class="mt-4 pt-2">
                                    <input data-mdb-ripple-init class="btn btn-primary btn-lg" type="submit" value="{{__('trans.Register')}}" />
                                </div>
